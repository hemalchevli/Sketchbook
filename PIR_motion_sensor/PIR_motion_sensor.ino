...
// What page to grab!
#define WEBSITE      "motionsensor.black-electronics.com"
#define WEBPAGE      "/save.php?temp=35&motion=1&pwd=p"
//motionsensor.black-electronics.com/save.php?temp=15&motion=1&pwd=p
